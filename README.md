...
$$ \{K_{k+1}} = \{P^{-}_\{k+1}}\{\{\hat{H}_{k+1}}}^\{T}{(\hat{H}_{k+1} \{P}^{-}_{k+1} \{\hat{H}_{k+1}}^\{T} + \{R})}^{-1} $$


$$ \{\hat{x}_\{k+1}} = \{\hat{x}^{-}_\{k}} +  \{K_\{k+1}} ( \{\{\begin{bmatrix}
\{\{a_y}_\{k+1}}\\
\{r_{k+1}} \end{bmatrix}} - \{H}*\{\hat{x}_\{k}}}) $$


$$ \{P_{k+1}} = \{(\{I} - \{K_\{k+1}} \{\hat{H}}) \{P^{-}_\{k+1}}}  $$
